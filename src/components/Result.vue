...
<template>
    <div class="result flex flex-row justify-center items-center text-white bg-second w-[98%] h-[30%] my-1 rounded-md border-border border-1 font-display ">
        <div class="avatar w-[10%] aspect-square ml-[3%] rounded-full bg-gradient-to-b from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% border-4 border-border">
            <img :src="avatar_url" alt="" srcset="" class="rounded-full">
        </div>
        <div class="info flex flex-col text-theme w-[75%] ml-[2%] h-full">
            
            <div class="repo mx-2 mt-2 h-[70%] flex flex-col justify-top">
                <div>
                    <div class="title text-[1.8vmin] w-full h-[40%]"><a :href="clone_url" target="_blank">{{ title }}</a></div>
                    <div class="desc text-[1.6vmin] w-full h-[60%]wrap line-clamp-2 text-white text-[1.1vmin] mt-0.5">{{ description }}</div>
                </div>
            </div>
