...
<template>
  ...
  <div id="sidebar" class="flex flex-col bg-primary w-[30vmin] h-full mx-2 font-display">
    <div id="logo"
      class="font-display  flex w-full flex-col items-center justify-center text-center text-white font-display text-[4vmin] h-[5%] mt-2">
      [ DEBUG ]
    </div>
...
<code>var a=1; var a=1; var a=1; var a=1; var a=1; var a=1;</code>
<code>var a=1; var a=1; var a=1; var a=1; var a=1; var a=1;</code>
...
<code>// Searching with @0.86</code>
      ...
      <div id="others" class="font-display  w-full pt-4 h-[20%] w-full flex flex-col justify-center items-center">
  ...
  <div id="main"
    ...
    <div id="author"
      class="font-display rounded-lg h-[5%] w-[80vmin] text-md text-[#fff] flex justify-center items-center bg-primary mt-[0.5%] text-white">
      <div class="text-[1.5vmin] text-center items-center flex justify-center">Made by<a href="" class="text-theme">&nbsp;@NUL4I </a>&nbsp;with:
        [&nbsp;
        ...
        <a href="" class="hover:-translate-y-1 hover:scale-120 transition duration-200 delay-50"><i class="devicon-github-original"></i></a>&nbsp;], deployed by <a href="">&nbsp;<i
    ...
    <div id="searchwindow"
      ...
      <div id="control" class=" w-full h-[25%] mt-[0.5%] px-2 text-white font-display text-[1.3vmin] flex justify-center items-center ">
        ...
        <div id="search" class="flex flex-col items-center w-[10%] h-full justify-right">
          <div id="searchbtn" class="cursor-pointer btn flex h-[90%] items-center w-full justify-center bg-primary transition delay-50 duration-300 ease-in-out hover:bg-theme rounded-md hover:text-[#fff]">search</div>
        </div>
      </div>
    </div>
    <div id="results" class="flex flex-col w-[80vmin] h-[50%] justify-top items-center py-5 ">
      <Result 
        title="NUL4I/StarGazer"
        description="Woops. Nothing here yet."
        :avatar_url="imageUrl"
        :clone_url="imageUrl"
        star=1
        fork=1
        update="T2024-12-12-09:00Z"
        lang="Python"
        sim=0.9897
        />
      <Result 
